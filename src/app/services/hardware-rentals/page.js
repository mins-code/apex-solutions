  ...
  return (
    <main className="min-h-screen pt-12 pb-20 px-6 md:px-12 lg:px-24">
      ...
      <section className="max-w-5xl mx-auto mb-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            {
              icon: "✅",
              title: "Pre-Tested & Ready",
              desc: "Every project is assembled and verified before handoff. No debugging required — just power on and demo.",
            },
            {
              icon: "📦",
              title: "Flexible Rental Periods",
              desc: "Rent for a day, a week, or longer. Pricing is discussed directly on WhatsApp based on your needs.",
            },
            {
              icon: "🎓",
              title: "Demo Support Included",
              desc: "We guide you on how to present the project to your panel, including explanation of circuit and code flow.",
            },
          ].map((f) => (
            <div
              key={f.title}
      ...
      <section className="max-w-7xl mx-auto">
        ...
        <p className="text-[#8b9bb4] mb-8 text-sm md:text-base">
          Browse our current rental catalogue. Click any project to see full details.
        </p>
      ...
      <section className="max-w-2xl mx-auto text-center mt-20">
        <p className="text-[#8b9bb4] mb-6 text-base">
          Don&apos;t see what you need? We may have more units available — just ask us directly.
        </p>
        <a
          href={`https://wa.me/91${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER}?text=${encodeURIComponent("Hi, I'm interested in renting a hardware project")}`}
          target="_blank"
