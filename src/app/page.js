...
export default function Home() {
  useEffect(() => {
    ...
    // Store original inline transitions, then set initial hidden state
    items.forEach((el) => {
        ...
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            ...
            setTimeout(() => {
              ...
              // Restore original transition so hover effects still work
              setTimeout(() => {
  ...
  return (
    <main className="min-h-screen pt-12 pb-20 px-6 md:px-12 lg:px-24">
      ...
      <section className="text-center max-w-3xl mx-auto py-16 md:py-24 mb-12">
        <h1
          className="text-4xl md:text-5xl lg:text-6xl font-montserrat tracking-tight font-bold text-white mb-6 leading-tight"
          data-reveal=""
          data-delay="0"
        >
          Your Project,{" "}
          <span
            style={{
              background:
                "linear-gradient(90deg, #3bbfbf 0%, #c07a3a 40%, #3bbfbf 80%, #c07a3a 100%)",
        ...
        <p
          className="text-[#8baab4] text-base md:text-lg leading-relaxed mb-10 max-w-2xl mx-auto"
          data-reveal=""
          data-delay="150"
        >
          Hardware rentals, software projects, IEEE papers, PPTs, and custom
          builds — for all engineering students in Bengaluru
        </p>
        <a
      ...
      <section className="max-w-7xl mx-auto mb-20">
        <h2
          className="text-3xl md:text-4xl font-montserrat font-bold text-white text-center mb-4 tracking-tight"
          data-reveal=""
          data-delay="0"
        >
          What We Offer
        ...
        <p
          className="text-[#8baab4] text-center mb-10 max-w-xl mx-auto"
          data-reveal=""
          data-delay="100"
        >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5">
          {[
            ...
            <a
              key={s.title}
              href={s.href}
              className="service-card glass-panel rounded-2xl p-6 flex flex-col items-center text-center gap-3 no-underline"
              data-reveal=""
            ...
            >
              <span className="service-emoji text-4xl mb-1 select-none">
                {s.emoji}
              </span>
              ...
              <span className="mt-2 inline-flex items-center gap-1 text-xs font-semibold text-[#3bbfbf]">
                Learn More <span className="arrow-slide">→</span>
              </span>
            </a>
          ))}
        </div>
